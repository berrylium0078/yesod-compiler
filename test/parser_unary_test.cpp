...
void testUnaryRecoveryDiagnostics()
{
    ...
    require(
        !malformedReturnValue.success(), "missing unary operand should fail");
    ...
    require(!malformedPrimaryExp.success(),
        "malformed parenthesized primary expression should fail");
    require(firstDiagnostic(malformedPrimaryExp).m_kind
